...
def inline_keyboard():
    ...
    button_skip = InlineKeyboardButton(text='▶️Пропустить',
                                       callback_data='skip')
...
def inline_keyboard_for_call():
    keyboard = InlineKeyboardMarkup()
    button_call_me = InlineKeyboardButton(text='📞Перезвоните мне',
...
def inline_kb_yes_or_change():
    ...
    button_change = InlineKeyboardButton(text='🔙Оставить номер телефона',
...
def inline_keyboard_finish_dialog():
    keyboard = InlineKeyboardMarkup()
    button_finish = InlineKeyboardButton(text='❌📞Завершить диалог',
...
def inline_keyboard_settings():
    keyboard = InlineKeyboardMarkup()
    button_change_name = InlineKeyboardButton(text='🛠Поменять имя',
                                              callback_data='change_name')
    button_change_phone = InlineKeyboardButton(text='🛠Сменить номер',
...
def answer_keyboard():
    keyboard = InlineKeyboardMarkup()
    answer_button = InlineKeyboardButton(text='Ответить',
